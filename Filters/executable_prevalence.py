...
class ExecutablePrevalence(RedwoodFilter):
    ...
    def __init__(self, cnx=None):
        self.name = "ExecutablePrevalence"
        self.score_table = "ep_scores"
        self.cnx = cnx
    ...
    def usage(self):
        ...
        print "---view histogram of file extension distribution for a single source with name <source_name>"
        print "\t- source_name: name of the source"
        print "[+] histogram_by_os <os_name>"
        print "---view file extension distribution for an os"
    ...
    def clean(self):
        ...
        """
        cursor = self.cnx.cursor() 
        cursor.execute("DROP TABLE IF EXISTS ep_scores")
        self.cnx.commit()
    ...
    def discover_histogram_by_os(self, os_name, output=None):
        """
        Displays a histogram of the distributions of file extensions that are
        executable across all systems of the specified OS
